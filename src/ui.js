...
const icon = `<svg class="h-full w-full" width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default class ui {
  static desktopUi() {
    const topBarUi = () => {
      ...
      namePreview.textContent = "RELEASE CANDIDATE";
